...
public class FireConstants {
    ...
    public static final DatabaseReference appSettings = mainRef.child("appSettings");
    public static final DatabaseReference adsControl = mainRef.child("adsControl");
    public static final DatabaseReference reportedGroups = mainRef.child("reportedGroups");
    public static final DatabaseReference reportedUsers = mainRef.child("reportedUsers");
    public static final DatabaseReference verificationRef = mainRef.child("verification");

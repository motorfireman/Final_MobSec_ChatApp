...
//        Uri uri = Uri.fromFile(new File(filePath));
        Uri uri = FileProvider.getUriForFile(MyApp.context(), MyApp.context().getPackageName()+".provider",new File(filePath) );
    ...
    public static Intent getSendEmailToVerifiedIntent(Context context) {
        String email = context.getString(R.string.email);
        Intent emailIntent = new Intent(Intent.ACTION_SEND);
        emailIntent.setType("message/rfc822");
        emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{email});
        emailIntent.putExtra(Intent.EXTRA_SUBJECT,"Verify my account for"+" "+context.getString(R.string.app_name));
    ...
    public static Intent getOpenfbIntent() {
        String fbId = MyApp.context().getString(R.string.fb_account);
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(fbId));
        return intent;
    }
    public static Intent getOpenytIntent(){
        String ytId=MyApp.context().getString(R.string.yt_account);
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(ytId));
        return intent;
    }
    public static Intent getOpenhelpIntent(){
        String ytId=MyApp.context().getString(R.string.yt_account);
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(ytId));
        return intent;
    }
    ...
    public static Intent getShareAppIntent(Context context) {
        ...
        String link = "https://ccswiper.page.link/share";

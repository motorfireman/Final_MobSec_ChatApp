...
// Activity that manages the user authentication flow, including phone number input, verification code input, and navigation between authentication-related fragments.

...
public final class NewGroupActivity extends com.teamxdevelopers.SuperChat.activities.ForwardActivity implements com.teamxdevelopers.SuperChat.adapters.ForwardAdapter.OnUserClick, com.teamxdevelopers.SuperChat.adapters.NewGroupSelectedUsersAdapter.OnUserClick, com.teamxdevelopers.SuperChat.activities.ForwardActivity.SearchCallback {
    ...
    public com.teamxdevelopers.SuperChat.adapters.NewGroupAdapter allUsersAdapter;
    public com.teamxdevelopers.SuperChat.adapters.NewGroupSelectedUsersAdapter selectedUsersAdapter;
    @org.jetbrains.annotations.Nullable
    private io.realm.RealmResults<com.teamxdevelopers.SuperChat.model.realms.User> users;
    public java.util.List<com.teamxdevelopers.SuperChat.model.realms.User> selectedUsers;
    @org.jetbrains.annotations.Nullable
    private java.util.List<? extends com.teamxdevelopers.SuperChat.model.realms.User> currentUsers;
    ...
    public final com.teamxdevelopers.SuperChat.adapters.NewGroupAdapter getAllUsersAdapter() {
        return null;
    }
    
    public final void setAllUsersAdapter(@org.jetbrains.annotations.NotNull
    com.teamxdevelopers.SuperChat.adapters.NewGroupAdapter p0) {
    }
    
    @org.jetbrains.annotations.NotNull
    public final com.teamxdevelopers.SuperChat.adapters.NewGroupSelectedUsersAdapter getSelectedUsersAdapter() {
        return null;
    }
    
    public final void setSelectedUsersAdapter(@org.jetbrains.annotations.NotNull
    com.teamxdevelopers.SuperChat.adapters.NewGroupSelectedUsersAdapter p0) {
    }
    
    @org.jetbrains.annotations.Nullable
    public final io.realm.RealmResults<com.teamxdevelopers.SuperChat.model.realms.User> getUsers() {
        return null;
    }
    
    public final void setUsers(@org.jetbrains.annotations.Nullable
    io.realm.RealmResults<com.teamxdevelopers.SuperChat.model.realms.User> p0) {
    }
    
    @org.jetbrains.annotations.NotNull
    public final java.util.List<com.teamxdevelopers.SuperChat.model.realms.User> getSelectedUsers() {
        return null;
    }
    
    public final void setSelectedUsers(@org.jetbrains.annotations.NotNull
    java.util.List<com.teamxdevelopers.SuperChat.model.realms.User> p0) {
    }
    
    @org.jetbrains.annotations.Nullable
    public final java.util.List<com.teamxdevelopers.SuperChat.model.realms.User> getCurrentUsers() {
        return null;
    }
    
    public final void setCurrentUsers(@org.jetbrains.annotations.Nullable
    java.util.List<? extends com.teamxdevelopers.SuperChat.model.realms.User> p0) {
    }
    ...
    com.teamxdevelopers.SuperChat.model.realms.User user, boolean added) {
    }

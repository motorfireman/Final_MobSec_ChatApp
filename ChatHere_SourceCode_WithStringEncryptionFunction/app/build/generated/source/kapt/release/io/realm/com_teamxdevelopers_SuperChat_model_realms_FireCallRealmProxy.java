...
public class com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy extends com.teamxdevelopers.SuperChat.model.realms.FireCall
    implements RealmObjectProxy, com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface {
    ...
    private ProxyState<com.teamxdevelopers.SuperChat.model.realms.FireCall> proxyState;

    com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.teamxdevelopers.SuperChat.model.realms.FireCall>(this);
    ...
    @SuppressWarnings("cast")
    public static com.teamxdevelopers.SuperChat.model.realms.FireCall createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.teamxdevelopers.SuperChat.model.realms.FireCall obj = null;
        if (update) {
            Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.FireCall.class);
            FireCallColumnInfo columnInfo = (FireCallColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.FireCall.class);
            ...
            if (objKey != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(objKey), realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.FireCall.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("callId")) {
                if (json.isNull("callId")) {
                    obj = (io.realm.com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy) realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.FireCall.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy) realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.FireCall.class, json.getString("callId"), true, excludeFields);
                }
            } else {
        ...
        final com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) obj;
        if (json.has("user")) {
            if (json.isNull("user")) {
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.FireCall createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.teamxdevelopers.SuperChat.model.realms.FireCall obj = new com.teamxdevelopers.SuperChat.model.realms.FireCall();
        final com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) obj;
        reader.beginObject();
    ...
    static com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.FireCall.class), false, Collections.<String>emptyList());
        io.realm.com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.teamxdevelopers.SuperChat.model.realms.FireCall copyOrUpdate(Realm realm, FireCallColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.FireCall object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.FireCall) cachedRealmObject;
        }

        com.teamxdevelopers.SuperChat.model.realms.FireCall realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.FireCall.class);
            long pkColumnKey = columnInfo.callIdColKey;
            String value = ((com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) object).realmGet$callId();
            long objKey = Table.NO_MATCH;
            if (value == null) {
                objKey = table.findFirstNull(pkColumnKey);
            } else {
            ...
            if (objKey == Table.NO_MATCH) {
                ...
                try {
                    ...
                    realmObject = new io.realm.com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy();
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.FireCall copy(Realm realm, FireCallColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.FireCall newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.FireCall) cachedRealmObject;
        }

        com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface unmanagedSource = (com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) newObject;
        ...
        io.realm.com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy managedCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.teamxdevelopers.SuperChat.model.realms.FireCall object, Map<RealmModel,Long> cache) {
        ...
        FireCallColumnInfo columnInfo = (FireCallColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.FireCall.class);
        long pkColumnKey = columnInfo.callIdColKey;
        String primaryKeyValue = ((com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) object).realmGet$callId();
        long objKey = Table.NO_MATCH;
        ...
        com.teamxdevelopers.SuperChat.model.realms.User userObj = ((com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.directionColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) object).realmGet$direction(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.timestampColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) object).realmGet$timestamp(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.durationColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) object).realmGet$duration(), false);
        String realmGet$phoneNumber = ((com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) object).realmGet$phoneNumber();
        if (realmGet$phoneNumber != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.phoneNumberColKey, objKey, realmGet$phoneNumber, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isVideoColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) object).realmGet$isVideo(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.callTypeColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) object).realmGet$callType(), false);
        String realmGet$channel = ((com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) object).realmGet$channel();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        FireCallColumnInfo columnInfo = (FireCallColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.FireCall.class);
        long pkColumnKey = columnInfo.callIdColKey;
        com.teamxdevelopers.SuperChat.model.realms.FireCall object = null;
        while (objects.hasNext()) {
            object = (com.teamxdevelopers.SuperChat.model.realms.FireCall) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.teamxdevelopers.SuperChat.model.realms.FireCall object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.FireCall.class);
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.FireCall createDetachedCopy(com.teamxdevelopers.SuperChat.model.realms.FireCall realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.teamxdevelopers.SuperChat.model.realms.FireCall unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.teamxdevelopers.SuperChat.model.realms.FireCall();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.teamxdevelopers.SuperChat.model.realms.FireCall) cachedObject.object;
            }
            unmanagedObject = (com.teamxdevelopers.SuperChat.model.realms.FireCall) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface unmanagedCopy = (com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) unmanagedObject;
        com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface realmSource = (com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) realmObject;
    ...
    static com.teamxdevelopers.SuperChat.model.realms.FireCall update(Realm realm, FireCallColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.FireCall realmObject, com.teamxdevelopers.SuperChat.model.realms.FireCall newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface realmObjectTarget = (com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) realmObject;
        com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface realmObjectSource = (com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxyInterface) newObject;
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.FireCall.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
    ...
    public boolean equals(Object o) {
        ...
        com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy aFireCall = (com_teamxdevelopers_SuperChat_model_realms_FireCallRealmProxy)o;

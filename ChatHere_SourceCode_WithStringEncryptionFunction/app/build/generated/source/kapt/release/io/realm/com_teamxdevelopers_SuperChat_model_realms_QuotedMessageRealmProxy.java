...
public class com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxy extends com.teamxdevelopers.SuperChat.model.realms.QuotedMessage
    implements RealmObjectProxy, com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface {
    ...
    private ProxyState<com.teamxdevelopers.SuperChat.model.realms.QuotedMessage> proxyState;

    com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.teamxdevelopers.SuperChat.model.realms.QuotedMessage>(this);
    ...
    @Override
    public com.teamxdevelopers.SuperChat.model.realms.Status realmGet$status() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.statusColKey)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.teamxdevelopers.SuperChat.model.realms.Status.class, proxyState.getRow$realm().getLink(columnInfo.statusColKey), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$status(com.teamxdevelopers.SuperChat.model.realms.Status value) {
        Realm realm = (Realm) proxyState.getRealm$realm();
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
    ...
    @SuppressWarnings("cast")
    public static com.teamxdevelopers.SuperChat.model.realms.QuotedMessage createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.teamxdevelopers.SuperChat.model.realms.QuotedMessage obj = realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.QuotedMessage.class, true, excludeFields);

        final com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) obj;
        ...
        if (json.has("status")) {
            if (json.isNull("status")) {
                ...
                com.teamxdevelopers.SuperChat.model.realms.Status statusObj = com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("status"), update);
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.QuotedMessage createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.teamxdevelopers.SuperChat.model.realms.QuotedMessage obj = new com.teamxdevelopers.SuperChat.model.realms.QuotedMessage();
        final com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.teamxdevelopers.SuperChat.model.realms.Status statusObj = com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$status(statusObj);
                }
            } else {
                reader.skipValue();
    ...
    static com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.QuotedMessage.class), false, Collections.<String>emptyList());
        io.realm.com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxy obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.teamxdevelopers.SuperChat.model.realms.QuotedMessage copyOrUpdate(Realm realm, QuotedMessageColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.QuotedMessage object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.QuotedMessage) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.teamxdevelopers.SuperChat.model.realms.QuotedMessage copy(Realm realm, QuotedMessageColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.QuotedMessage newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.QuotedMessage) cachedRealmObject;
        }

        com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface unmanagedSource = (com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) newObject;

        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.QuotedMessage.class);
        ...
        io.realm.com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxy managedCopy = newProxyInstance(realm, row);
        ...
        com.teamxdevelopers.SuperChat.model.realms.Status statusObj = unmanagedSource.realmGet$status();
        if (statusObj == null) {
            managedCopy.realmSet$status(null);
        } else {
            com.teamxdevelopers.SuperChat.model.realms.Status cachestatus = (com.teamxdevelopers.SuperChat.model.realms.Status) cache.get(statusObj);
            if (cachestatus != null) {
                managedCopy.realmSet$status(cachestatus);
            } else {
                managedCopy.realmSet$status(com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy.StatusColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Status.class), statusObj, update, cache, flags));
            }
        }
    ...
    public static long insert(Realm realm, com.teamxdevelopers.SuperChat.model.realms.QuotedMessage object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.QuotedMessage.class);
        long tableNativePtr = table.getNativePtr();
        QuotedMessageColumnInfo columnInfo = (QuotedMessageColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.QuotedMessage.class);
        long objKey = OsObject.createRow(table);
        cache.put(object, objKey);
        String realmGet$messageId = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$messageId();
        if (realmGet$messageId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.messageIdColKey, objKey, realmGet$messageId, false);
        }
        String realmGet$fromId = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$fromId();
        if (realmGet$fromId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fromIdColKey, objKey, realmGet$fromId, false);
        }
        String realmGet$fromPhone = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$fromPhone();
        ...
        String realmGet$toId = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$toId();
        if (realmGet$toId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.toIdColKey, objKey, realmGet$toId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.typeColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$type(), false);
        String realmGet$content = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$content();
        if (realmGet$content != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.contentColKey, objKey, realmGet$content, false);
        }
        String realmGet$metadata = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$metadata();
        if (realmGet$metadata != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.metadataColKey, objKey, realmGet$metadata, false);
        }
        String realmGet$mediaDuration = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$mediaDuration();
        ...
        String realmGet$thumb = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$thumb();
        if (realmGet$thumb != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.thumbColKey, objKey, realmGet$thumb, false);
        }
        String realmGet$fileSize = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$fileSize();
        if (realmGet$fileSize != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fileSizeColKey, objKey, realmGet$fileSize, false);
        }

        com.teamxdevelopers.SuperChat.model.realms.RealmContact contactObj = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$contact();
        if (contactObj != null) {
        ...
        com.teamxdevelopers.SuperChat.model.realms.RealmLocation locationObj = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$location();
        if (locationObj != null) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBroadcastColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$isBroadcast(), false);
        String realmGet$encryptionType = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$encryptionType();
        ...
        com.teamxdevelopers.SuperChat.model.realms.Status statusObj = ((com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$status();
        if (statusObj != null) {
            Long cachestatus = cache.get(statusObj);
            if (cachestatus == null) {
                cachestatus = com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy.insert(realm, statusObj, cache);
            }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        QuotedMessageColumnInfo columnInfo = (QuotedMessageColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.QuotedMessage.class);
        com.teamxdevelopers.SuperChat.model.realms.QuotedMessage object = null;
        while (objects.hasNext()) {
            object = (com.teamxdevelopers.SuperChat.model.realms.QuotedMessage) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.teamxdevelopers.SuperChat.model.realms.QuotedMessage object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.QuotedMessage.class);
        ...
        if (statusObj != null) {
            Long cachestatus = cache.get(statusObj);
            if (cachestatus == null) {
                cachestatus = com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy.insertOrUpdate(realm, statusObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.statusColKey, objKey, cachestatus, false);
        } else {
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.QuotedMessage createDetachedCopy(com.teamxdevelopers.SuperChat.model.realms.QuotedMessage realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.teamxdevelopers.SuperChat.model.realms.QuotedMessage unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.teamxdevelopers.SuperChat.model.realms.QuotedMessage();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.teamxdevelopers.SuperChat.model.realms.QuotedMessage) cachedObject.object;
            }
            unmanagedObject = (com.teamxdevelopers.SuperChat.model.realms.QuotedMessage) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface unmanagedCopy = (com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) unmanagedObject;
        com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface realmSource = (com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxyInterface) realmObject;
        ...
        // Deep copy of status
        unmanagedCopy.realmSet$status(com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy.createDetachedCopy(realmSource.realmGet$status(), currentDepth + 1, maxDepth, cache));
    ...
    public boolean equals(Object o) {
        ...
        com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxy aQuotedMessage = (com_teamxdevelopers_SuperChat_model_realms_QuotedMessageRealmProxy)o;

...
public class com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy extends com.teamxdevelopers.SuperChat.model.realms.User
    implements RealmObjectProxy, com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface {
    ...
    private ProxyState<com.teamxdevelopers.SuperChat.model.realms.User> proxyState;

    com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.teamxdevelopers.SuperChat.model.realms.User>(this);
    ...
    public boolean realmGet$verified() {
        proxyState.getRealm$realm().checkIfValid();
        return (boolean) proxyState.getRow$realm().getBoolean(columnInfo.verifiedColKey);
    }
    ...
    public void realmSet$verified(boolean value) {
        if (proxyState.isUnderConstruction()) {
            ...
            final Row row = proxyState.getRow$realm();
            row.getTable().setBoolean(columnInfo.verifiedColKey, row.getObjectKey(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setBoolean(columnInfo.verifiedColKey, value);
    }
    ...
    public com.teamxdevelopers.SuperChat.model.realms.Group realmGet$group() {
        ...
        return proxyState.getRealm$realm().get(com.teamxdevelopers.SuperChat.model.realms.Group.class, proxyState.getRow$realm().getLink(columnInfo.groupColKey), false, Collections.<String>emptyList());
    }
    ...
    public com.teamxdevelopers.SuperChat.model.realms.Broadcast realmGet$broadcast() {
        ...
        return proxyState.getRealm$realm().get(com.teamxdevelopers.SuperChat.model.realms.Broadcast.class, proxyState.getRow$realm().getLink(columnInfo.broadcastColKey), false, Collections.<String>emptyList());
    }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("User", false, 16, 0);
    ...
    @SuppressWarnings("cast")
    public static com.teamxdevelopers.SuperChat.model.realms.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.teamxdevelopers.SuperChat.model.realms.User obj = null;
        if (update) {
            Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.User.class);
            ...
            if (objKey != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(objKey), realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.User.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("uid")) {
                if (json.isNull("uid")) {
                    obj = (io.realm.com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy) realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy) realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.User.class, json.getString("uid"), true, excludeFields);
                }
            } else {
        ...
        final com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) obj;
        if (json.has("photo")) {
        ...
        if (json.has("group")) {
            if (json.isNull("group")) {
                ...
                com.teamxdevelopers.SuperChat.model.realms.Group groupObj = com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("group"), update);
        ...
        if (json.has("broadcast")) {
            if (json.isNull("broadcast")) {
                ...
                com.teamxdevelopers.SuperChat.model.realms.Broadcast broadcastObj = com_teamxdevelopers_SuperChat_model_realms_BroadcastRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("broadcast"), update);
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.teamxdevelopers.SuperChat.model.realms.User obj = new com.teamxdevelopers.SuperChat.model.realms.User();
        final com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.teamxdevelopers.SuperChat.model.realms.Group groupObj = com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$group(groupObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.teamxdevelopers.SuperChat.model.realms.Broadcast broadcastObj = com_teamxdevelopers_SuperChat_model_realms_BroadcastRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$broadcast(broadcastObj);
                }
    ...
    static com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.User.class), false, Collections.<String>emptyList());
        io.realm.com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.teamxdevelopers.SuperChat.model.realms.User copyOrUpdate(Realm realm, UserColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.User) cachedRealmObject;
        }

        com.teamxdevelopers.SuperChat.model.realms.User realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.User.class);
            long pkColumnKey = columnInfo.uidColKey;
            String value = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$uid();
            long objKey = Table.NO_MATCH;
            if (value == null) {
                objKey = table.findFirstNull(pkColumnKey);
            } else {
            ...
            if (objKey == Table.NO_MATCH) {
                ...
                try {
                    ...
                    realmObject = new io.realm.com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy();
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.User copy(Realm realm, UserColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.User) cachedRealmObject;
        }

        com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface unmanagedSource = (com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) newObject;
        ...
        builder.addBoolean(columnInfo.verifiedColKey, unmanagedSource.realmGet$verified());
        ...
        io.realm.com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy managedCopy = newProxyInstance(realm, row);
        cache.put(newObject, managedCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        com.teamxdevelopers.SuperChat.model.realms.Group groupObj = unmanagedSource.realmGet$group();
        if (groupObj == null) {
            managedCopy.realmSet$group(null);
        } else {
            com.teamxdevelopers.SuperChat.model.realms.Group cachegroup = (com.teamxdevelopers.SuperChat.model.realms.Group) cache.get(groupObj);
            if (cachegroup != null) {
                managedCopy.realmSet$group(cachegroup);
            } else {
                managedCopy.realmSet$group(com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy.GroupColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Group.class), groupObj, update, cache, flags));
            }
        }

        com.teamxdevelopers.SuperChat.model.realms.Broadcast broadcastObj = unmanagedSource.realmGet$broadcast();
        if (broadcastObj == null) {
            managedCopy.realmSet$broadcast(null);
        } else {
            com.teamxdevelopers.SuperChat.model.realms.Broadcast cachebroadcast = (com.teamxdevelopers.SuperChat.model.realms.Broadcast) cache.get(broadcastObj);
            if (cachebroadcast != null) {
                managedCopy.realmSet$broadcast(cachebroadcast);
            } else {
                managedCopy.realmSet$broadcast(com_teamxdevelopers_SuperChat_model_realms_BroadcastRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_BroadcastRealmProxy.BroadcastColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Broadcast.class), broadcastObj, update, cache, flags));
            }
        }
    ...
    public static long insert(Realm realm, com.teamxdevelopers.SuperChat.model.realms.User object, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.User.class);
        long pkColumnKey = columnInfo.uidColKey;
        String primaryKeyValue = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$uid();
        long objKey = Table.NO_MATCH;
        ...
        String realmGet$photo = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$photo();
        if (realmGet$photo != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.photoColKey, objKey, realmGet$photo, false);
        }
        String realmGet$status = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusColKey, objKey, realmGet$status, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.verifiedColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$verified(), false);
        String realmGet$phone = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$phone();
        if (realmGet$phone != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.phoneColKey, objKey, realmGet$phone, false);
        }
        String realmGet$userLocalPhoto = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$userLocalPhoto();
        ...
        String realmGet$userName = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$userName();
        if (realmGet$userName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userNameColKey, objKey, realmGet$userName, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBlockedColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$isBlocked(), false);
        String realmGet$appVer = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$appVer();
        if (realmGet$appVer != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.appVerColKey, objKey, realmGet$appVer, false);
        }
        String realmGet$thumbImg = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$thumbImg();
        if (realmGet$thumbImg != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.thumbImgColKey, objKey, realmGet$thumbImg, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isGroupBoolColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$isGroupBool(), false);

        com.teamxdevelopers.SuperChat.model.realms.Group groupObj = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
            Long cachegroup = cache.get(groupObj);
            if (cachegroup == null) {
                cachegroup = com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy.insert(realm, groupObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.groupColKey, objKey, cachegroup, false);
        }

        com.teamxdevelopers.SuperChat.model.realms.Broadcast broadcastObj = ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$broadcast();
        if (broadcastObj != null) {
            Long cachebroadcast = cache.get(broadcastObj);
            if (cachebroadcast == null) {
                cachebroadcast = com_teamxdevelopers_SuperChat_model_realms_BroadcastRealmProxy.insert(realm, broadcastObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.broadcastColKey, objKey, cachebroadcast, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBroadcastBoolColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$isBroadcastBool(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isStoredInContactsColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$isStoredInContacts(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.lastTimeFetchedImageColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) object).realmGet$lastTimeFetchedImage(), false);
        return objKey;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.User.class);
        long pkColumnKey = columnInfo.uidColKey;
        com.teamxdevelopers.SuperChat.model.realms.User object = null;
        while (objects.hasNext()) {
            object = (com.teamxdevelopers.SuperChat.model.realms.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.teamxdevelopers.SuperChat.model.realms.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.User.class);
        ...
        if (groupObj != null) {
            Long cachegroup = cache.get(groupObj);
            if (cachegroup == null) {
                cachegroup = com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy.insertOrUpdate(realm, groupObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.groupColKey, objKey, cachegroup, false);
        } else {
        ...
        if (broadcastObj != null) {
            Long cachebroadcast = cache.get(broadcastObj);
            if (cachebroadcast == null) {
                cachebroadcast = com_teamxdevelopers_SuperChat_model_realms_BroadcastRealmProxy.insertOrUpdate(realm, broadcastObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.broadcastColKey, objKey, cachebroadcast, false);
        } else {
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.User createDetachedCopy(com.teamxdevelopers.SuperChat.model.realms.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.teamxdevelopers.SuperChat.model.realms.User unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.teamxdevelopers.SuperChat.model.realms.User();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.teamxdevelopers.SuperChat.model.realms.User) cachedObject.object;
            }
            unmanagedObject = (com.teamxdevelopers.SuperChat.model.realms.User) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface unmanagedCopy = (com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) unmanagedObject;
        com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface realmSource = (com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) realmObject;
        ...
        // Deep copy of group
        unmanagedCopy.realmSet$group(com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy.createDetachedCopy(realmSource.realmGet$group(), currentDepth + 1, maxDepth, cache));

        // Deep copy of broadcast
        unmanagedCopy.realmSet$broadcast(com_teamxdevelopers_SuperChat_model_realms_BroadcastRealmProxy.createDetachedCopy(realmSource.realmGet$broadcast(), currentDepth + 1, maxDepth, cache));
    ...
    static com.teamxdevelopers.SuperChat.model.realms.User update(Realm realm, UserColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.User realmObject, com.teamxdevelopers.SuperChat.model.realms.User newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface realmObjectTarget = (com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) realmObject;
        com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface realmObjectSource = (com_teamxdevelopers_SuperChat_model_realms_UserRealmProxyInterface) newObject;
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.User.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
        ...
        builder.addBoolean(columnInfo.verifiedColKey, realmObjectSource.realmGet$verified());
        ...
        com.teamxdevelopers.SuperChat.model.realms.Group groupObj = realmObjectSource.realmGet$group();
        if (groupObj == null) {
            ...
            if (cachegroup != null) {
                ...
                builder.addObject(columnInfo.groupColKey, com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy.GroupColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Group.class), groupObj, true, cache, flags));
            }
        }

        com.teamxdevelopers.SuperChat.model.realms.Broadcast broadcastObj = realmObjectSource.realmGet$broadcast();
        if (broadcastObj == null) {
            ...
            if (cachebroadcast != null) {
                ...
                builder.addObject(columnInfo.broadcastColKey, com_teamxdevelopers_SuperChat_model_realms_BroadcastRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_BroadcastRealmProxy.BroadcastColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Broadcast.class), broadcastObj, true, cache, flags));
            }
        }

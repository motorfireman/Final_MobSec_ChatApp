...
//handles recieving messages and process it from firestore
...
/*
the handleNewMessage function is crucial for handling incoming messages from FCM, parsing their content,
saving them to the local database, and updating the user interface to reflect the new message.
This ensures that messages are correctly processed, displayed to the user, and stored for future reference within the app.
 */

...
import com.teamxdevelopers.SuperChat.extensions.await
...
// ViewModel that handles the logic for user authentication, including initiating phone number verification, verifying the code, and managing UI state during the authentication process.

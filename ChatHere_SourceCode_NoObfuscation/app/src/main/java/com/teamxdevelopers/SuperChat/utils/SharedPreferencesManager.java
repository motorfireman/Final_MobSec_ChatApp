...
import com.teamxdevelopers.SuperChat.model.constants.NetworkType;
...
public class SharedPreferencesManager {
    ...
    public static void saveGroupIsEnabledHideParticipateFromGid(String gid, Boolean bool) {
        mSharedPref.edit().putBoolean(gid, bool).apply();
    }
    public static void saveGroupIsEnabledHideParticipate(Boolean bool) {
        mSharedPref.edit().putBoolean("Group", bool).apply();
    }
    //dark Mode
    public static void saveDarkMode(String mode) {
        mSharedPref.edit().putString("dark_mode", mode).apply();
    }
    public static void setHideOnline(boolean hideOnline){
        mSharedPref.edit().putBoolean("hideOnline",hideOnline);
    }
    //Verify
    public static void saveIsVerify(String uid,String verify) {
        mSharedPref.edit().putString(uid, verify).apply();
    }
    public static void setIsOnEmojiRain(Boolean bool) {
        mSharedPref.edit().putBoolean("IsOnEmojiRain", bool).apply();
    }
    public static void setIsOnSmartReply(Boolean bool) {
        mSharedPref.edit().putBoolean("IsOnSmartReply", bool).apply();
    }
    //font size
    public static void saveFontSize(int size) {
        mSharedPref.edit().putInt("font_size", size).apply();
    }
    public static void savessblock(String uid,String block) {
        mSharedPref.edit().putString(uid, block).apply();
    }
    ...
    public static Boolean getIsOnEmojiRain() {
        return mSharedPref.getBoolean("IsOnEmojiRain", true);
    }

    public static Boolean getIsOnSmartReply() {
        return mSharedPref.getBoolean("IsOnSmartReply", true);
    }
    ...
    public static Boolean getGroupIsEnabledHideParticipateFromGid(String gid) {
        return mSharedPref.getBoolean(gid, false);
    }
    public static Boolean getGroupIsEnabledHideParticipate() {
        return mSharedPref.getBoolean("Group", false);
    }
    //Dark Mode
    ...
    public static String getssblock(String uid) {
        return mSharedPref.getString(uid, "");
    }
    //verify
    public static String getIsVerify(String uid) {
        return mSharedPref.getString(uid, "");
    }
    //Font size
    ...
    public static void setAllUsersNotificationSubscribe(boolean b) {
        mSharedPref.edit().putBoolean("all_users_notification_subscribe", b).apply();
    }
    ...
    public static void setClickedSettingsItem(int item) {
        mSharedPref.edit().putInt("clicked_settings_item", item).apply();
    }

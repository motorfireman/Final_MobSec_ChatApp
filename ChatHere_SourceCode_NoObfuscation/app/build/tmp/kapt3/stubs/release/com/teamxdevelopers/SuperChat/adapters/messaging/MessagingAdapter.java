...
public final class MessagingAdapter extends io.realm.RealmRecyclerViewAdapter<com.teamxdevelopers.SuperChat.model.realms.Message, androidx.recyclerview.widget.RecyclerView.ViewHolder> implements ca.barrenechea.widget.recyclerview.decoration.StickyHeaderAdapter<androidx.recyclerview.widget.RecyclerView.ViewHolder> {
    ...
    private final androidx.lifecycle.LiveData<java.util.List<com.teamxdevelopers.SuperChat.model.realms.Message>> selectedItems = null;
    private final androidx.lifecycle.LiveData<java.util.Map<java.lang.String, java.lang.Integer>> progressMap = null;
    private final androidx.lifecycle.LiveData<java.util.Map<java.lang.String, com.teamxdevelopers.SuperChat.model.AudibleState>> audibleState = null;
    private final com.teamxdevelopers.SuperChat.adapters.messaging.Interaction interaction = null;
    private final com.teamxdevelopers.SuperChat.adapters.messaging.ContactHolderInteraction contactHolderInteraction = null;
    private final com.teamxdevelopers.SuperChat.adapters.messaging.AudibleInteraction audibleHolderInteraction = null;
    @org.jetbrains.annotations.NotNull
    ...
    io.realm.OrderedRealmCollection<com.teamxdevelopers.SuperChat.model.realms.Message> messages, boolean autoUpdate, @org.jetbrains.annotations.NotNull
    android.content.Context context, @org.jetbrains.annotations.NotNull
    androidx.lifecycle.LifecycleOwner lifecycleOwner, @org.jetbrains.annotations.NotNull
    com.teamxdevelopers.SuperChat.model.realms.User user, @org.jetbrains.annotations.NotNull
    java.lang.String myThumbImg, @org.jetbrains.annotations.NotNull
    androidx.lifecycle.LiveData<java.util.List<com.teamxdevelopers.SuperChat.model.realms.Message>> selectedItems, @org.jetbrains.annotations.NotNull
    ...
    androidx.lifecycle.LiveData<java.util.Map<java.lang.String, com.teamxdevelopers.SuperChat.model.AudibleState>> audibleState) {
        super(null, false);
    }
    
    @org.jetbrains.annotations.NotNull
    public final com.teamxdevelopers.SuperChat.model.realms.User getUser() {
        return null;
    }
    
    public final void setUser(@org.jetbrains.annotations.NotNull
    com.teamxdevelopers.SuperChat.model.realms.User p0) {
    }
    ...
    private final void initHolder(com.teamxdevelopers.SuperChat.adapters.messaging.holders.base.BaseHolder baseHolder) {
    }
    
    private final void initAudibleHolder(com.teamxdevelopers.SuperChat.adapters.messaging.AudibleBase audibleBase) {
    }
    
    private final void initContactHolder(com.teamxdevelopers.SuperChat.adapters.messaging.ContactHolderBase contactHolderBase) {
    }

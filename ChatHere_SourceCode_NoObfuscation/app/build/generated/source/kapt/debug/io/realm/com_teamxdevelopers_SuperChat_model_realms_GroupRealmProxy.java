...
public class com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy extends com.teamxdevelopers.SuperChat.model.realms.Group
    implements RealmObjectProxy, com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface {
    ...
    static final class GroupColumnInfo extends ColumnInfo {
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.disabledColKey = src.disabledColKey;
    ...
    private ProxyState<com.teamxdevelopers.SuperChat.model.realms.Group> proxyState;
    private RealmList<com.teamxdevelopers.SuperChat.model.realms.User> usersRealmList;
    private RealmList<String> adminsUidsRealmList;

    com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.teamxdevelopers.SuperChat.model.realms.Group>(this);
    ...
    @Override
    public RealmList<com.teamxdevelopers.SuperChat.model.realms.User> realmGet$users() {
        proxyState.getRealm$realm().checkIfValid();
        ...
        if (usersRealmList != null) {
            ...
            usersRealmList = new RealmList<com.teamxdevelopers.SuperChat.model.realms.User>(com.teamxdevelopers.SuperChat.model.realms.User.class, osList, proxyState.getRealm$realm());
            return usersRealmList;
        }
    }

    @Override
    public void realmSet$users(RealmList<com.teamxdevelopers.SuperChat.model.realms.User> value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.teamxdevelopers.SuperChat.model.realms.User> original = value;
                value = new RealmList<com.teamxdevelopers.SuperChat.model.realms.User>();
                for (com.teamxdevelopers.SuperChat.model.realms.User item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.teamxdevelopers.SuperChat.model.realms.User linkedObject = value.get(i);
    ...
    public boolean realmGet$disabled() {
        proxyState.getRealm$realm().checkIfValid();
        return (boolean) proxyState.getRow$realm().getBoolean(columnInfo.disabledColKey);
    }

    @Override
    public void realmSet$disabled(boolean value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            final Row row = proxyState.getRow$realm();
            row.getTable().setBoolean(columnInfo.disabledColKey, row.getObjectKey(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setBoolean(columnInfo.disabledColKey, value);
    }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Group", false, 9, 0);
        ...
        builder.addPersistedProperty("disabled", RealmFieldType.BOOLEAN, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED);
    ...
    @SuppressWarnings("cast")
    public static com.teamxdevelopers.SuperChat.model.realms.Group createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.teamxdevelopers.SuperChat.model.realms.Group obj = null;
        if (update) {
            Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Group.class);
            GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Group.class);
            ...
            if (objKey != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(objKey), realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Group.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("groupId")) {
                if (json.isNull("groupId")) {
                    obj = (io.realm.com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy) realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.Group.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy) realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.Group.class, json.getString("groupId"), true, excludeFields);
                }
            } else {
        ...
        final com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) obj;
        ...
        if (json.has("users")) {
            if (json.isNull("users")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.teamxdevelopers.SuperChat.model.realms.User item = com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.Group createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.teamxdevelopers.SuperChat.model.realms.Group obj = new com.teamxdevelopers.SuperChat.model.realms.Group();
        final com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$users(new RealmList<com.teamxdevelopers.SuperChat.model.realms.User>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.teamxdevelopers.SuperChat.model.realms.User item = com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$users().add(item);
                    }
                    reader.endArray();
                }
                ...
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$disabled((boolean) reader.nextBoolean());
                } else {
                    reader.skipValue();
                    throw new IllegalArgumentException("Trying to set non-nullable field 'disabled' to null.");
                }
    ...
    static com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Group.class), false, Collections.<String>emptyList());
        io.realm.com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.teamxdevelopers.SuperChat.model.realms.Group copyOrUpdate(Realm realm, GroupColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.Group object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.Group) cachedRealmObject;
        }

        com.teamxdevelopers.SuperChat.model.realms.Group realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Group.class);
            long pkColumnKey = columnInfo.groupIdColKey;
            String value = ((com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) object).realmGet$groupId();
            long objKey = Table.NO_MATCH;
            if (value == null) {
                objKey = table.findFirstNull(pkColumnKey);
            } else {
            ...
            if (objKey == Table.NO_MATCH) {
                ...
                try {
                    ...
                    realmObject = new io.realm.com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy();
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.Group copy(Realm realm, GroupColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.Group newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.Group) cachedRealmObject;
        }

        com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface unmanagedSource = (com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) newObject;
        ...
        builder.addBoolean(columnInfo.disabledColKey, unmanagedSource.realmGet$disabled());
        ...
        io.realm.com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy managedCopy = newProxyInstance(realm, row);
        cache.put(newObject, managedCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        RealmList<com.teamxdevelopers.SuperChat.model.realms.User> usersUnmanagedList = unmanagedSource.realmGet$users();
        if (usersUnmanagedList != null) {
            RealmList<com.teamxdevelopers.SuperChat.model.realms.User> usersManagedList = managedCopy.realmGet$users();
            usersManagedList.clear();
            for (int i = 0; i < usersUnmanagedList.size(); i++) {
                com.teamxdevelopers.SuperChat.model.realms.User usersUnmanagedItem = usersUnmanagedList.get(i);
                com.teamxdevelopers.SuperChat.model.realms.User cacheusers = (com.teamxdevelopers.SuperChat.model.realms.User) cache.get(usersUnmanagedItem);
                if (cacheusers != null) {
                    usersManagedList.add(cacheusers);
                } else {
                    usersManagedList.add(com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy.UserColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.User.class), usersUnmanagedItem, update, cache, flags));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.teamxdevelopers.SuperChat.model.realms.Group object, Map<RealmModel,Long> cache) {
        ...
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Group.class);
        long pkColumnKey = columnInfo.groupIdColKey;
        String primaryKeyValue = ((com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) object).realmGet$groupId();
        long objKey = Table.NO_MATCH;
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isActiveColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) object).realmGet$isActive(), false);
        String realmGet$createdByNumber = ((com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) object).realmGet$createdByNumber();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.timestampColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) object).realmGet$timestamp(), false);

        RealmList<com.teamxdevelopers.SuperChat.model.realms.User> usersList = ((com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) object).realmGet$users();
        if (usersList != null) {
            OsList usersOsList = new OsList(table.getUncheckedRow(objKey), columnInfo.usersColKey);
            for (com.teamxdevelopers.SuperChat.model.realms.User usersItem : usersList) {
                Long cacheItemIndexusers = cache.get(usersItem);
                if (cacheItemIndexusers == null) {
                    cacheItemIndexusers = com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy.insert(realm, usersItem, cache);
                }
                usersOsList.addRow(cacheItemIndexusers);
            }
        }

        RealmList<java.lang.String> adminsUidsList = ((com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) object).realmGet$adminsUids();
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.onlyAdminsCanPostColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) object).realmGet$onlyAdminsCanPost(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.disabledColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) object).realmGet$disabled(), false);
        String realmGet$currentGroupLink = ((com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) object).realmGet$currentGroupLink();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Group.class);
        long pkColumnKey = columnInfo.groupIdColKey;
        com.teamxdevelopers.SuperChat.model.realms.Group object = null;
        while (objects.hasNext()) {
            object = (com.teamxdevelopers.SuperChat.model.realms.Group) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.teamxdevelopers.SuperChat.model.realms.Group object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Group.class);
        ...
        if (usersList != null && usersList.size() == usersOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.teamxdevelopers.SuperChat.model.realms.User usersItem = usersList.get(i);
                Long cacheItemIndexusers = cache.get(usersItem);
                if (cacheItemIndexusers == null) {
                    cacheItemIndexusers = com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy.insertOrUpdate(realm, usersItem, cache);
                }
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.Group createDetachedCopy(com.teamxdevelopers.SuperChat.model.realms.Group realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.teamxdevelopers.SuperChat.model.realms.Group unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.teamxdevelopers.SuperChat.model.realms.Group();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.teamxdevelopers.SuperChat.model.realms.Group) cachedObject.object;
            }
            unmanagedObject = (com.teamxdevelopers.SuperChat.model.realms.Group) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface unmanagedCopy = (com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) unmanagedObject;
        com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface realmSource = (com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) realmObject;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.teamxdevelopers.SuperChat.model.realms.User> managedusersList = realmSource.realmGet$users();
            RealmList<com.teamxdevelopers.SuperChat.model.realms.User> unmanagedusersList = new RealmList<com.teamxdevelopers.SuperChat.model.realms.User>();
            unmanagedCopy.realmSet$users(unmanagedusersList);
            int nextDepth = currentDepth + 1;
            int size = managedusersList.size();
            for (int i = 0; i < size; i++) {
                com.teamxdevelopers.SuperChat.model.realms.User item = com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy.createDetachedCopy(managedusersList.get(i), nextDepth, maxDepth, cache);
        ...
        unmanagedCopy.realmSet$disabled(realmSource.realmGet$disabled());
        unmanagedCopy.realmSet$currentGroupLink(realmSource.realmGet$currentGroupLink());

        return unmanagedObject;
    }

    static com.teamxdevelopers.SuperChat.model.realms.Group update(Realm realm, GroupColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.Group realmObject, com.teamxdevelopers.SuperChat.model.realms.Group newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface realmObjectTarget = (com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) realmObject;
        com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface realmObjectSource = (com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxyInterface) newObject;
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Group.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
        ...
        RealmList<com.teamxdevelopers.SuperChat.model.realms.User> usersUnmanagedList = realmObjectSource.realmGet$users();
        if (usersUnmanagedList != null) {
            RealmList<com.teamxdevelopers.SuperChat.model.realms.User> usersManagedCopy = new RealmList<com.teamxdevelopers.SuperChat.model.realms.User>();
            for (int i = 0; i < usersUnmanagedList.size(); i++) {
                com.teamxdevelopers.SuperChat.model.realms.User usersItem = usersUnmanagedList.get(i);
                com.teamxdevelopers.SuperChat.model.realms.User cacheusers = (com.teamxdevelopers.SuperChat.model.realms.User) cache.get(usersItem);
                if (cacheusers != null) {
                    usersManagedCopy.add(cacheusers);
                } else {
                    usersManagedCopy.add(com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_UserRealmProxy.UserColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.User.class), usersItem, true, cache, flags));
                }
            }
            builder.addObjectList(columnInfo.usersColKey, usersManagedCopy);
        } else {
            builder.addObjectList(columnInfo.usersColKey, new RealmList<com.teamxdevelopers.SuperChat.model.realms.User>());
        }
        ...
        builder.addBoolean(columnInfo.disabledColKey, realmObjectSource.realmGet$disabled());
    ...
    public boolean equals(Object o) {
        ...
        com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy aGroup = (com_teamxdevelopers_SuperChat_model_realms_GroupRealmProxy)o;

...
//        fetchUserVerified(userId);
        ...
        cardViewEncryption.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String encryptionWeb = MyApp.context().getString(R.string.encryptionWeb);
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(encryptionWeb));

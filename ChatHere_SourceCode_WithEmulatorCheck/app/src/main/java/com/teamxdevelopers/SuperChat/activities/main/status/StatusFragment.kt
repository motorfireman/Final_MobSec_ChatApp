...
import com.teamxdevelopers.SuperChat.activities.main.MainActivity.Companion.CAMERA_REQUEST
import com.teamxdevelopers.SuperChat.activities.main.MainActivity.Companion.REQUEST_CODE_TEXT_STATUS
import com.teamxdevelopers.SuperChat.activities.main.MainViewModel
import com.teamxdevelopers.SuperChat.activities.main.status.StatusFragmentEvent.OnActivityResultEvent
import com.teamxdevelopers.SuperChat.activities.main.status.StatusFragmentEvent.StatusInsertedEvent
...
//        return resources.getBoolean(R.bool.is_status_ad_enabled)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(adapter.itemCount <= 0){
            rv_status.visibility=View.GONE
            no_status.visibility=View.VISIBLE
        }else{
            rv_status.visibility=View.VISIBLE
            no_status.visibility=View.GONE
        }
    }

...
//        return resources.getBoolean(R.bool.is_calls_ad_enabled)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.queryTextChange.observe(viewLifecycleOwner, androidx.lifecycle.Observer { newText ->
            ...
            if (adapter.itemCount<=0){
                rv_calls.visibility=View.GONE
                no_calls.visibility=View.VISIBLE
            }else{
                rv_calls.visibility=View.VISIBLE
                no_calls.visibility=View.GONE
            }
    ...
    private fun initAdapter() {
        ...
        adapter =CallsAdapter(
            fireCallList,
            selectedFireCallListActionMode,
            activity,
            this@CallsFragment
        )

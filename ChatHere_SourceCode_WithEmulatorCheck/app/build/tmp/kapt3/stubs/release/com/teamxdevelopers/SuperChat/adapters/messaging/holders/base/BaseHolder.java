...
public class BaseHolder extends androidx.recyclerview.widget.RecyclerView.ViewHolder {
    ...
    @org.jetbrains.annotations.Nullable
    private com.teamxdevelopers.SuperChat.adapters.messaging.Interaction interaction;
    @org.jetbrains.annotations.Nullable
    ...
    @org.jetbrains.annotations.Nullable
    private androidx.lifecycle.LiveData<java.util.List<com.teamxdevelopers.SuperChat.model.realms.Message>> selectedItems;
    ...
    @org.jetbrains.annotations.Nullable
    public final com.teamxdevelopers.SuperChat.adapters.messaging.Interaction getInteraction() {
        return null;
    }
    
    public final void setInteraction(@org.jetbrains.annotations.Nullable
    com.teamxdevelopers.SuperChat.adapters.messaging.Interaction p0) {
    }
    ...
    @org.jetbrains.annotations.Nullable
    public final androidx.lifecycle.LiveData<java.util.List<com.teamxdevelopers.SuperChat.model.realms.Message>> getSelectedItems() {
        return null;
    }
    
    public final void setSelectedItems(@org.jetbrains.annotations.Nullable
    androidx.lifecycle.LiveData<java.util.List<com.teamxdevelopers.SuperChat.model.realms.Message>> p0) {
    }
    ...
    private final void setQuotedTextDrawable(com.teamxdevelopers.SuperChat.model.realms.Message quotedMessage) {
    }
    
    private final java.lang.String getQuotedUsername(com.teamxdevelopers.SuperChat.model.realms.Message quotedMessage, com.teamxdevelopers.SuperChat.model.realms.User user) {
        return null;
    }
}
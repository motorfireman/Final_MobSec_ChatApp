...
public class com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxy extends com.teamxdevelopers.SuperChat.model.realms.Message
    implements RealmObjectProxy, com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface {
    ...
    private ProxyState<com.teamxdevelopers.SuperChat.model.realms.Message> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.teamxdevelopers.SuperChat.model.realms.Message>(this);
    ...
    @SuppressWarnings("cast")
    public static com.teamxdevelopers.SuperChat.model.realms.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.teamxdevelopers.SuperChat.model.realms.Message obj = realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.Message.class, true, excludeFields);

        final com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) obj;
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.teamxdevelopers.SuperChat.model.realms.Message obj = new com.teamxdevelopers.SuperChat.model.realms.Message();
        final com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) obj;
        reader.beginObject();
    ...
    static com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Message.class), false, Collections.<String>emptyList());
        io.realm.com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxy obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.teamxdevelopers.SuperChat.model.realms.Message copyOrUpdate(Realm realm, MessageColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.Message) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.teamxdevelopers.SuperChat.model.realms.Message copy(Realm realm, MessageColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.Message) cachedRealmObject;
        }

        com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface unmanagedSource = (com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) newObject;

        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Message.class);
        ...
        io.realm.com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxy managedCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.teamxdevelopers.SuperChat.model.realms.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Message.class);
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Message.class);
        long objKey = OsObject.createRow(table);
        cache.put(object, objKey);
        String realmGet$messageId = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$messageId();
        if (realmGet$messageId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.messageIdColKey, objKey, realmGet$messageId, false);
        }
        String realmGet$fromId = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$fromId();
        if (realmGet$fromId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fromIdColKey, objKey, realmGet$fromId, false);
        }
        String realmGet$fromPhone = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$fromPhone();
        ...
        String realmGet$toId = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$toId();
        if (realmGet$toId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.toIdColKey, objKey, realmGet$toId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.typeColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$type(), false);
        String realmGet$content = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$content();
        if (realmGet$content != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.contentColKey, objKey, realmGet$content, false);
        }
        String realmGet$partialText = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$partialText();
        ...
        String realmGet$timestamp = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$timestamp();
        if (realmGet$timestamp != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.timestampColKey, objKey, realmGet$timestamp, false);
        }
        String realmGet$chatId = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$chatId();
        if (realmGet$chatId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatIdColKey, objKey, realmGet$chatId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.messageStatColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$messageStat(), false);
        String realmGet$localPath = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$localPath();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.downloadUploadStatColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$downloadUploadStat(), false);
        String realmGet$metadata = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$metadata();
        if (realmGet$metadata != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.metadataColKey, objKey, realmGet$metadata, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.voiceMessageSeenColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$voiceMessageSeen(), false);
        String realmGet$mediaDuration = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$mediaDuration();
        ...
        String realmGet$thumb = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$thumb();
        if (realmGet$thumb != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.thumbColKey, objKey, realmGet$thumb, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isForwardedColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$isForwarded(), false);
        String realmGet$videoThumb = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$videoThumb();
        ...
        String realmGet$fileSize = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$fileSize();
        if (realmGet$fileSize != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fileSizeColKey, objKey, realmGet$fileSize, false);
        }

        com.teamxdevelopers.SuperChat.model.realms.RealmContact contactObj = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$contact();
        if (contactObj != null) {
        ...
        com.teamxdevelopers.SuperChat.model.realms.RealmLocation locationObj = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$location();
        if (locationObj != null) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isGroupColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$isGroup(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBroadcastColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$isBroadcast(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isSeenColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$isSeen(), false);

        RealmList<java.lang.String> broadcastUidsList = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$broadcastUids();
        ...
        String realmGet$encryptionType = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$encryptionType();
        ...
        String realmGet$uri = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$uri();
        if (realmGet$uri != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.uriColKey, objKey, realmGet$uri, false);
        }

        com.teamxdevelopers.SuperChat.model.realms.QuotedMessage quotedMessageObj = ((com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) object).realmGet$quotedMessage();
        if (quotedMessageObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Message.class);
        com.teamxdevelopers.SuperChat.model.realms.Message object = null;
        while (objects.hasNext()) {
            object = (com.teamxdevelopers.SuperChat.model.realms.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.teamxdevelopers.SuperChat.model.realms.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Message.class);
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.Message createDetachedCopy(com.teamxdevelopers.SuperChat.model.realms.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.teamxdevelopers.SuperChat.model.realms.Message unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.teamxdevelopers.SuperChat.model.realms.Message();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.teamxdevelopers.SuperChat.model.realms.Message) cachedObject.object;
            }
            unmanagedObject = (com.teamxdevelopers.SuperChat.model.realms.Message) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface unmanagedCopy = (com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) unmanagedObject;
        com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface realmSource = (com_teamxdevelopers_SuperChat_model_realms_MessageRealmProxyInterface) realmObject;

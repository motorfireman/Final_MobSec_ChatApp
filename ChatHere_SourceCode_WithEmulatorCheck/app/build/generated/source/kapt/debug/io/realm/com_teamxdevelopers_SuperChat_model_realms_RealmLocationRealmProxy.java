...
public class com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxy extends com.teamxdevelopers.SuperChat.model.realms.RealmLocation
    implements RealmObjectProxy, com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface {
    ...
    private ProxyState<com.teamxdevelopers.SuperChat.model.realms.RealmLocation> proxyState;

    com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.teamxdevelopers.SuperChat.model.realms.RealmLocation>(this);
    ...
    @SuppressWarnings("cast")
    public static com.teamxdevelopers.SuperChat.model.realms.RealmLocation createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.teamxdevelopers.SuperChat.model.realms.RealmLocation obj = realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.RealmLocation.class, true, excludeFields);

        final com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) obj;
        if (json.has("lat")) {
            if (json.isNull("lat")) {
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.RealmLocation createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.teamxdevelopers.SuperChat.model.realms.RealmLocation obj = new com.teamxdevelopers.SuperChat.model.realms.RealmLocation();
        final com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) obj;
        reader.beginObject();
    ...
    static com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.RealmLocation.class), false, Collections.<String>emptyList());
        io.realm.com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxy obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.teamxdevelopers.SuperChat.model.realms.RealmLocation copyOrUpdate(Realm realm, RealmLocationColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.RealmLocation object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.RealmLocation) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.teamxdevelopers.SuperChat.model.realms.RealmLocation copy(Realm realm, RealmLocationColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.RealmLocation newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.RealmLocation) cachedRealmObject;
        }

        com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface unmanagedSource = (com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) newObject;

        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.RealmLocation.class);
        ...
        io.realm.com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxy managedCopy = newProxyInstance(realm, row);
        cache.put(newObject, managedCopy);

        return managedCopy;
    }

    public static long insert(Realm realm, com.teamxdevelopers.SuperChat.model.realms.RealmLocation object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.RealmLocation.class);
        long tableNativePtr = table.getNativePtr();
        RealmLocationColumnInfo columnInfo = (RealmLocationColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.RealmLocation.class);
        long objKey = OsObject.createRow(table);
        cache.put(object, objKey);
        Table.nativeSetDouble(tableNativePtr, columnInfo.latColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) object).realmGet$lat(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.lngColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) object).realmGet$lng(), false);
        String realmGet$address = ((com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) object).realmGet$address();
        if (realmGet$address != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.addressColKey, objKey, realmGet$address, false);
        }
        String realmGet$name = ((com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameColKey, objKey, realmGet$name, false);
        }
        String realmGet$latStr = ((com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) object).realmGet$latStr();
        if (realmGet$latStr != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.latStrColKey, objKey, realmGet$latStr, false);
        }
        String realmGet$lngStr = ((com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) object).realmGet$lngStr();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        RealmLocationColumnInfo columnInfo = (RealmLocationColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.RealmLocation.class);
        com.teamxdevelopers.SuperChat.model.realms.RealmLocation object = null;
        while (objects.hasNext()) {
            object = (com.teamxdevelopers.SuperChat.model.realms.RealmLocation) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.teamxdevelopers.SuperChat.model.realms.RealmLocation object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.RealmLocation.class);
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.RealmLocation createDetachedCopy(com.teamxdevelopers.SuperChat.model.realms.RealmLocation realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.teamxdevelopers.SuperChat.model.realms.RealmLocation unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.teamxdevelopers.SuperChat.model.realms.RealmLocation();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.teamxdevelopers.SuperChat.model.realms.RealmLocation) cachedObject.object;
            }
            unmanagedObject = (com.teamxdevelopers.SuperChat.model.realms.RealmLocation) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface unmanagedCopy = (com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) unmanagedObject;
        com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface realmSource = (com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxy aRealmLocation = (com_teamxdevelopers_SuperChat_model_realms_RealmLocationRealmProxy)o;

package com.teamxdevelopers.SuperChat.utils.glide;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.teamxdevelopers.SuperChat.utils.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.teamxdevelopers.SuperChat.utils.glide.GlideOptions().apply(toSet));
    }
  }
}

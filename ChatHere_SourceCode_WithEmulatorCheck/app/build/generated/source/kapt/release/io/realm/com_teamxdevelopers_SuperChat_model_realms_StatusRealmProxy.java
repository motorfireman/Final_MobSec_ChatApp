...
public class com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy extends com.teamxdevelopers.SuperChat.model.realms.Status
    implements RealmObjectProxy, com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface {
    ...
    private ProxyState<com.teamxdevelopers.SuperChat.model.realms.Status> proxyState;
    private RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> seenByRealmList;

    com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.teamxdevelopers.SuperChat.model.realms.Status>(this);
    ...
    public com.teamxdevelopers.SuperChat.model.realms.TextStatus realmGet$textStatus() {
        ...
        return proxyState.getRealm$realm().get(com.teamxdevelopers.SuperChat.model.realms.TextStatus.class, proxyState.getRow$realm().getLink(columnInfo.textStatusColKey), false, Collections.<String>emptyList());
    }
    ...
    public RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> realmGet$seenBy() {
        ...
        if (seenByRealmList != null) {
            ...
            seenByRealmList = new RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy>(com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy.class, osList, proxyState.getRealm$realm());
            return seenByRealmList;
        }
    }
    ...
    public void realmSet$seenBy(RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> original = value;
                value = new RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy>();
                for (com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.teamxdevelopers.SuperChat.model.realms.Status createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.teamxdevelopers.SuperChat.model.realms.Status obj = null;
        if (update) {
            Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Status.class);
            StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Status.class);
            ...
            if (objKey != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(objKey), realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Status.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("statusId")) {
                if (json.isNull("statusId")) {
                    obj = (io.realm.com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy) realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.Status.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy) realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.Status.class, json.getString("statusId"), true, excludeFields);
                }
            } else {
        ...
        final com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) obj;
        if (json.has("userId")) {
        ...
        if (json.has("textStatus")) {
            if (json.isNull("textStatus")) {
                ...
                com.teamxdevelopers.SuperChat.model.realms.TextStatus textStatusObj = com_teamxdevelopers_SuperChat_model_realms_TextStatusRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("textStatus"), update);
        ...
        if (json.has("seenBy")) {
            if (json.isNull("seenBy")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy item = com_teamxdevelopers_SuperChat_model_realms_StatusSeenByRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.Status createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.teamxdevelopers.SuperChat.model.realms.Status obj = new com.teamxdevelopers.SuperChat.model.realms.Status();
        final com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.teamxdevelopers.SuperChat.model.realms.TextStatus textStatusObj = com_teamxdevelopers_SuperChat_model_realms_TextStatusRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$textStatus(textStatusObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$seenBy(new RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy item = com_teamxdevelopers_SuperChat_model_realms_StatusSeenByRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$seenBy().add(item);
                    }
                    reader.endArray();
                }
    ...
    static com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Status.class), false, Collections.<String>emptyList());
        io.realm.com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.teamxdevelopers.SuperChat.model.realms.Status copyOrUpdate(Realm realm, StatusColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.Status object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.Status) cachedRealmObject;
        }

        com.teamxdevelopers.SuperChat.model.realms.Status realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Status.class);
            long pkColumnKey = columnInfo.statusIdColKey;
            String value = ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$statusId();
            long objKey = Table.NO_MATCH;
            if (value == null) {
                objKey = table.findFirstNull(pkColumnKey);
            } else {
            ...
            if (objKey == Table.NO_MATCH) {
                ...
                try {
                    ...
                    realmObject = new io.realm.com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy();
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.Status copy(Realm realm, StatusColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.Status newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.Status) cachedRealmObject;
        }

        com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface unmanagedSource = (com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) newObject;
        ...
        io.realm.com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxy managedCopy = newProxyInstance(realm, row);
        cache.put(newObject, managedCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        com.teamxdevelopers.SuperChat.model.realms.TextStatus textStatusObj = unmanagedSource.realmGet$textStatus();
        if (textStatusObj == null) {
            managedCopy.realmSet$textStatus(null);
        } else {
            com.teamxdevelopers.SuperChat.model.realms.TextStatus cachetextStatus = (com.teamxdevelopers.SuperChat.model.realms.TextStatus) cache.get(textStatusObj);
            if (cachetextStatus != null) {
                managedCopy.realmSet$textStatus(cachetextStatus);
            } else {
                managedCopy.realmSet$textStatus(com_teamxdevelopers_SuperChat_model_realms_TextStatusRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_TextStatusRealmProxy.TextStatusColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.TextStatus.class), textStatusObj, update, cache, flags));
            }
        }

        RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> seenByUnmanagedList = unmanagedSource.realmGet$seenBy();
        if (seenByUnmanagedList != null) {
            RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> seenByManagedList = managedCopy.realmGet$seenBy();
            seenByManagedList.clear();
            for (int i = 0; i < seenByUnmanagedList.size(); i++) {
                com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy seenByUnmanagedItem = seenByUnmanagedList.get(i);
                com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy cacheseenBy = (com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy) cache.get(seenByUnmanagedItem);
                if (cacheseenBy != null) {
                    seenByManagedList.add(cacheseenBy);
                } else {
                    seenByManagedList.add(com_teamxdevelopers_SuperChat_model_realms_StatusSeenByRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_StatusSeenByRealmProxy.StatusSeenByColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy.class), seenByUnmanagedItem, update, cache, flags));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.teamxdevelopers.SuperChat.model.realms.Status object, Map<RealmModel,Long> cache) {
        ...
        StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Status.class);
        long pkColumnKey = columnInfo.statusIdColKey;
        String primaryKeyValue = ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$statusId();
        long objKey = Table.NO_MATCH;
        ...
        String realmGet$userId = ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdColKey, objKey, realmGet$userId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.timestampColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$timestamp(), false);
        String realmGet$thumbImg = ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$thumbImg();
        if (realmGet$thumbImg != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.thumbImgColKey, objKey, realmGet$thumbImg, false);
        }
        String realmGet$content = ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$content();
        if (realmGet$content != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.contentColKey, objKey, realmGet$content, false);
        }
        String realmGet$localPath = ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$localPath();
        ...
        com.teamxdevelopers.SuperChat.model.realms.TextStatus textStatusObj = ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$textStatus();
        if (textStatusObj != null) {
            Long cachetextStatus = cache.get(textStatusObj);
            if (cachetextStatus == null) {
                cachetextStatus = com_teamxdevelopers_SuperChat_model_realms_TextStatusRealmProxy.insert(realm, textStatusObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.textStatusColKey, objKey, cachetextStatus, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.typeColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$type(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.durationColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$duration(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.seenCountColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$seenCount(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.seenCountSentColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$seenCountSent(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isSeenColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$isSeen(), false);

        RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> seenByList = ((com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) object).realmGet$seenBy();
        if (seenByList != null) {
            OsList seenByOsList = new OsList(table.getUncheckedRow(objKey), columnInfo.seenByColKey);
            for (com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy seenByItem : seenByList) {
                Long cacheItemIndexseenBy = cache.get(seenByItem);
                if (cacheItemIndexseenBy == null) {
                    cacheItemIndexseenBy = com_teamxdevelopers_SuperChat_model_realms_StatusSeenByRealmProxy.insert(realm, seenByItem, cache);
                }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.Status.class);
        long pkColumnKey = columnInfo.statusIdColKey;
        com.teamxdevelopers.SuperChat.model.realms.Status object = null;
        while (objects.hasNext()) {
            object = (com.teamxdevelopers.SuperChat.model.realms.Status) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.teamxdevelopers.SuperChat.model.realms.Status object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Status.class);
        ...
        if (textStatusObj != null) {
            Long cachetextStatus = cache.get(textStatusObj);
            if (cachetextStatus == null) {
                cachetextStatus = com_teamxdevelopers_SuperChat_model_realms_TextStatusRealmProxy.insertOrUpdate(realm, textStatusObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.textStatusColKey, objKey, cachetextStatus, false);
        } else {
        ...
        if (seenByList != null && seenByList.size() == seenByOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy seenByItem = seenByList.get(i);
                Long cacheItemIndexseenBy = cache.get(seenByItem);
                if (cacheItemIndexseenBy == null) {
                    cacheItemIndexseenBy = com_teamxdevelopers_SuperChat_model_realms_StatusSeenByRealmProxy.insertOrUpdate(realm, seenByItem, cache);
                }
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.Status createDetachedCopy(com.teamxdevelopers.SuperChat.model.realms.Status realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.teamxdevelopers.SuperChat.model.realms.Status unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.teamxdevelopers.SuperChat.model.realms.Status();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.teamxdevelopers.SuperChat.model.realms.Status) cachedObject.object;
            }
            unmanagedObject = (com.teamxdevelopers.SuperChat.model.realms.Status) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface unmanagedCopy = (com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) unmanagedObject;
        com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface realmSource = (com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) realmObject;
        ...
        unmanagedCopy.realmSet$textStatus(com_teamxdevelopers_SuperChat_model_realms_TextStatusRealmProxy.createDetachedCopy(realmSource.realmGet$textStatus(), currentDepth + 1, maxDepth, cache));
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> managedseenByList = realmSource.realmGet$seenBy();
            RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> unmanagedseenByList = new RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy>();
            unmanagedCopy.realmSet$seenBy(unmanagedseenByList);
            int nextDepth = currentDepth + 1;
            int size = managedseenByList.size();
            for (int i = 0; i < size; i++) {
                com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy item = com_teamxdevelopers_SuperChat_model_realms_StatusSeenByRealmProxy.createDetachedCopy(managedseenByList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.teamxdevelopers.SuperChat.model.realms.Status update(Realm realm, StatusColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.Status realmObject, com.teamxdevelopers.SuperChat.model.realms.Status newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface realmObjectTarget = (com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) realmObject;
        com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface realmObjectSource = (com_teamxdevelopers_SuperChat_model_realms_StatusRealmProxyInterface) newObject;
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.Status.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
        ...
        com.teamxdevelopers.SuperChat.model.realms.TextStatus textStatusObj = realmObjectSource.realmGet$textStatus();
        if (textStatusObj == null) {
            ...
            if (cachetextStatus != null) {
                ...
                builder.addObject(columnInfo.textStatusColKey, com_teamxdevelopers_SuperChat_model_realms_TextStatusRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_TextStatusRealmProxy.TextStatusColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.TextStatus.class), textStatusObj, true, cache, flags));
            }
        }
        ...
        RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> seenByUnmanagedList = realmObjectSource.realmGet$seenBy();
        if (seenByUnmanagedList != null) {
            RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy> seenByManagedCopy = new RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy>();
            for (int i = 0; i < seenByUnmanagedList.size(); i++) {
                com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy seenByItem = seenByUnmanagedList.get(i);
                com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy cacheseenBy = (com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy) cache.get(seenByItem);
                if (cacheseenBy != null) {
                    seenByManagedCopy.add(cacheseenBy);
                } else {
                    seenByManagedCopy.add(com_teamxdevelopers_SuperChat_model_realms_StatusSeenByRealmProxy.copyOrUpdate(realm, (com_teamxdevelopers_SuperChat_model_realms_StatusSeenByRealmProxy.StatusSeenByColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy.class), seenByItem, true, cache, flags));
                }
            }
            builder.addObjectList(columnInfo.seenByColKey, seenByManagedCopy);
        } else {
            builder.addObjectList(columnInfo.seenByColKey, new RealmList<com.teamxdevelopers.SuperChat.model.realms.StatusSeenBy>());
        }

...
public class com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxy extends com.teamxdevelopers.SuperChat.model.realms.GroupEvent
    implements RealmObjectProxy, com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface {
    ...
    private ProxyState<com.teamxdevelopers.SuperChat.model.realms.GroupEvent> proxyState;

    com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.teamxdevelopers.SuperChat.model.realms.GroupEvent>(this);
    ...
    @SuppressWarnings("cast")
    public static com.teamxdevelopers.SuperChat.model.realms.GroupEvent createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.teamxdevelopers.SuperChat.model.realms.GroupEvent obj = realm.createObjectInternal(com.teamxdevelopers.SuperChat.model.realms.GroupEvent.class, true, excludeFields);

        final com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface) obj;
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.GroupEvent createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.teamxdevelopers.SuperChat.model.realms.GroupEvent obj = new com.teamxdevelopers.SuperChat.model.realms.GroupEvent();
        final com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface objProxy = (com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface) obj;
        reader.beginObject();
    ...
    static com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.GroupEvent.class), false, Collections.<String>emptyList());
        io.realm.com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxy obj = new io.realm.com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.teamxdevelopers.SuperChat.model.realms.GroupEvent copyOrUpdate(Realm realm, GroupEventColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.GroupEvent object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.GroupEvent) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.teamxdevelopers.SuperChat.model.realms.GroupEvent copy(Realm realm, GroupEventColumnInfo columnInfo, com.teamxdevelopers.SuperChat.model.realms.GroupEvent newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.teamxdevelopers.SuperChat.model.realms.GroupEvent) cachedRealmObject;
        }

        com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface unmanagedSource = (com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface) newObject;

        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.GroupEvent.class);
        ...
        io.realm.com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxy managedCopy = newProxyInstance(realm, row);
        cache.put(newObject, managedCopy);

        return managedCopy;
    }

    public static long insert(Realm realm, com.teamxdevelopers.SuperChat.model.realms.GroupEvent object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.GroupEvent.class);
        long tableNativePtr = table.getNativePtr();
        GroupEventColumnInfo columnInfo = (GroupEventColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.GroupEvent.class);
        long objKey = OsObject.createRow(table);
        cache.put(object, objKey);
        String realmGet$contextStart = ((com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface) object).realmGet$contextStart();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.eventTypeColKey, objKey, ((com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface) object).realmGet$eventType(), false);
        String realmGet$contextEnd = ((com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface) object).realmGet$contextEnd();
        ...
        String realmGet$timestamp = ((com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface) object).realmGet$timestamp();
        if (realmGet$timestamp != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.timestampColKey, objKey, realmGet$timestamp, false);
        }
        String realmGet$eventId = ((com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface) object).realmGet$eventId();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        GroupEventColumnInfo columnInfo = (GroupEventColumnInfo) realm.getSchema().getColumnInfo(com.teamxdevelopers.SuperChat.model.realms.GroupEvent.class);
        com.teamxdevelopers.SuperChat.model.realms.GroupEvent object = null;
        while (objects.hasNext()) {
            object = (com.teamxdevelopers.SuperChat.model.realms.GroupEvent) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.teamxdevelopers.SuperChat.model.realms.GroupEvent object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.teamxdevelopers.SuperChat.model.realms.GroupEvent.class);
    ...
    public static com.teamxdevelopers.SuperChat.model.realms.GroupEvent createDetachedCopy(com.teamxdevelopers.SuperChat.model.realms.GroupEvent realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.teamxdevelopers.SuperChat.model.realms.GroupEvent unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.teamxdevelopers.SuperChat.model.realms.GroupEvent();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.teamxdevelopers.SuperChat.model.realms.GroupEvent) cachedObject.object;
            }
            unmanagedObject = (com.teamxdevelopers.SuperChat.model.realms.GroupEvent) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface unmanagedCopy = (com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface) unmanagedObject;
        com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface realmSource = (com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxy aGroupEvent = (com_teamxdevelopers_SuperChat_model_realms_GroupEventRealmProxy)o;
